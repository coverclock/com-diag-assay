...
int main(void)
{
...

    {
        ...
        ASSERT((cfp = assay_config_create()) != (assay_config_t *)0);
        ASSERT(assay_config_audit(cfp) == (void *)0);
        ASSERT(assay_section_seek(cfp, "Alfa") == (assay_section_t *)0);
        ASSERT(assay_config_audit(cfp) == (void *)0);
        ASSERT((scp = assay_section_create(cfp, "Alfa")) != (assay_section_t *)0);
        ASSERT(assay_config_audit(cfp) == 0);
        ASSERT(assay_section_seek(cfp, "Alfa") == scp);
        ...
        ASSERT(assay_property_seek(scp, "One") == (assay_property_t *)0);
...

    {
        ...
        ASSERT(assay_config_audit(cfp) == (void *)0);
        ASSERT(assay_section_seek(cfp, "Alfa") == (assay_section_t *)0);
        ASSERT(assay_section_seek(cfp, "Bravo") == (assay_section_t *)0);
        ASSERT(assay_section_seek(cfp, "Charlie") == (assay_section_t *)0);
        ASSERT((scp[0] = assay_section_create(cfp, "Alfa")) != (assay_section_t *)0);
        ASSERT(assay_config_audit(cfp) == (void *)0);
        ASSERT(assay_section_seek(cfp, "Alfa") == scp[0]);
        ASSERT(assay_section_seek(cfp, "Bravo") == (assay_section_t *)0);
        ASSERT(assay_section_seek(cfp, "Charlie") == (assay_section_t *)0);
        ...
        ASSERT(assay_config_audit(cfp) == (void *)0);
        ASSERT(assay_section_seek(cfp, "Alfa") == scp[0]);
        ASSERT(assay_section_seek(cfp, "Bravo") == scp[1]);
        ASSERT(assay_section_seek(cfp, "Charlie") == (assay_section_t *)0);
        ASSERT(assay_section_first(cfp) == scp[0]);
        ...
        ASSERT(assay_section_seek(cfp, "Alfa") == scp[0]);
        ASSERT(assay_section_seek(cfp, "Bravo") == scp[1]);
        ASSERT(assay_section_seek(cfp, "Charlie") == scp[2]);
        ASSERT(assay_section_first(cfp) == scp[0]);
        ASSERT(assay_section_next(scp[0]) == scp[1]);
        ASSERT(assay_section_prev(scp[0]) == (assay_section_t *)0);
...

    {
        ...
        ASSERT(assay_config_audit(cfp) == (void *)0);
        /**/
        ASSERT(assay_section_seek(cfp, SECTION) == (assay_section_t *)0);
        ...
        ASSERT(assay_config_audit(cfp) == 0);
        ASSERT(assay_section_seek(cfp, SECTION) == scp);
        ASSERT(assay_section_first(cfp) == scp);
        ASSERT(assay_section_next(scp) == (assay_section_t *)0);
        ASSERT(assay_section_prev(scp) == (assay_section_t *)0);
        ASSERT(assay_section_last(cfp) == scp);
        ...
        /**/
        ASSERT(assay_property_seek(scp, KEY) == (assay_property_t *)0);
        ASSERT(assay_property_first(scp) == (assay_property_t *)0);
        ASSERT(assay_property_last(scp) == (assay_property_t *)0);
        ASSERT((prp = assay_property_create(scp, KEY)) != (assay_property_t *)0);
        ASSERT(assay_config_audit(cfp) == 0);
        ASSERT(assay_property_seek(scp, KEY) == prp);
...

    {
        ...
        ASSERT(assay_config_audit(cfp) == (void *)0);
        {
            ...
            size_t length;
            /**/
            ASSERT((scp = assay_section_seek(cfp, "Alfa")) != (assay_section_t *)0);
            ASSERT((prp = assay_property_seek(scp, "One")) != (assay_property_t *)0);
            ...
            ASSERT((prp = assay_property_seek(scp, "Two")) == (assay_property_t *)0);
            ASSERT((prp = assay_property_seek(scp, "Three")) == (assay_property_t *)0);
            /**/
            ASSERT((scp = assay_section_seek(cfp, "Bravo")) != (assay_section_t *)0);
            ASSERT((prp = assay_property_seek(scp, "One")) != (assay_property_t *)0);
            ASSERT((key = assay_key_get(prp)) != (const char *)0);
            ASSERT(strcmp(key, "One") == 0);
            ASSERT((value = (const char *)assay_value_get(prp, &length)) != (const char *)0);
            ...
            ASSERT((prp = assay_property_seek(scp, "Three")) == (assay_property_t *)0);
            /**/
            ASSERT((scp = assay_section_seek(cfp, "Charlie")) != (assay_section_t *)0);
            ASSERT((prp = assay_property_seek(scp, "One")) != (assay_property_t *)0);
            ASSERT((key = assay_key_get(prp)) != (const char *)0);
            ASSERT(strcmp(key, "One") == 0);
            ASSERT((value = (const char *)assay_value_get(prp, &length)) != (const char *)0);
        ...
        ASSERT(assay_config_audit(cfp) == (void *)0);
        {
            ...
            ASSERT((prp = assay_property_seek(scp, "Two")) != (assay_property_t *)0);
            assay_property_destroy(prp);
            ASSERT(assay_property_seek(scp, "Two") == (assay_property_t *)0);
            ASSERT(assay_section_seek(cfp, "Bravo") == scp);
            /**/
            ASSERT((scp = assay_section_seek(cfp, "Charlie")) != (assay_section_t *)0);
            ASSERT((prp = assay_property_seek(scp, "One")) != (assay_property_t *)0);
            assay_property_destroy(prp);
            ...
            ASSERT((prp = assay_property_seek(scp, "Three")) != (assay_property_t *)0);
            assay_property_destroy(prp);
            ASSERT(assay_property_seek(scp, "Three") == (assay_property_t *)0);
            ASSERT(assay_section_seek(cfp, "Charlie") == scp);
        }
        ASSERT(assay_config_audit(cfp) == (void *)0);
        assay_config_destroy(cfp);
    }

    {
        ...
        ASSERT(assay_config_audit(cfp) == (void *)0);
        {
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Bravo", "One")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Bravo", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Bravo", "Three")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Charlie", "One")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Charlie", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Charlie", "Three")) == (const char *)0);
            /**/
            assay_config_set(cfp, "Alfa", "One", "1");
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) != (const char *)0);
            ASSERT(strcmp(value, "1") == 0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
            ...
            ASSERT((value = assay_config_get(cfp, "Charlie", "Three")) == (const char *)0);
            /**/
            assay_config_set(cfp, "Bravo", "One", "11");
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) != (const char *)0);
            ASSERT(strcmp(value, "1") == 0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
            ...
            ASSERT((value = assay_config_get(cfp, "Charlie", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Charlie", "Three")) == (const char *)0);
            assay_config_set(cfp, "Bravo", "Two", "22");
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) != (const char *)0);
            ASSERT(strcmp(value, "1") == 0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
            ...
            ASSERT((value = assay_config_get(cfp, "Charlie", "Three")) == (const char *)0);
            /**/
            assay_config_set(cfp, "Charlie", "One", "111");
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) != (const char *)0);
            ASSERT(strcmp(value, "1") == 0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
            ...
            ASSERT((value = assay_config_get(cfp, "Charlie", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Charlie", "Three")) == (const char *)0);
            assay_config_set(cfp, "Charlie", "Two", "222");
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) != (const char *)0);
            ASSERT(strcmp(value, "1") == 0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
            ...
            ASSERT(strcmp(value, "222") == 0);
            ASSERT((value = assay_config_get(cfp, "Charlie", "Three")) == (const char *)0);
            assay_config_set(cfp, "Charlie", "Three", "333");
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) != (const char *)0);
            ASSERT(strcmp(value, "1") == 0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
        ...
        ASSERT(assay_config_audit(cfp) == (void *)0);
        {
            ...
            ASSERT((value = assay_config_get(cfp, "Charlie", "Three")) != (const char *)0);
            /**/
            assay_config_set(cfp, "Alfa", "One", "A");
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) != (const char *)0);
            ASSERT(strcmp(value, "A") == 0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
            ...
            ASSERT(strcmp(value, "333") == 0);
            /**/
            assay_config_set(cfp, "Bravo", "One", "AA");
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) != (const char *)0);
            ASSERT(strcmp(value, "A") == 0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
            ...
            ASSERT((value = assay_config_get(cfp, "Charlie", "Three")) != (const char *)0);
            ASSERT(strcmp(value, "333") == 0);
            assay_config_set(cfp, "Bravo", "Two", "BB");
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) != (const char *)0);
            ASSERT(strcmp(value, "A") == 0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
            ...
            ASSERT(strcmp(value, "333") == 0);
            /**/
            assay_config_set(cfp, "Charlie", "One", "AAA");
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) != (const char *)0);
            ASSERT(strcmp(value, "A") == 0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
            ...
            ASSERT((value = assay_config_get(cfp, "Charlie", "Three")) != (const char *)0);
            ASSERT(strcmp(value, "333") == 0);
            assay_config_set(cfp, "Charlie", "Two", "BBB");
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) != (const char *)0);
            ASSERT(strcmp(value, "A") == 0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
            ...
            ASSERT((value = assay_config_get(cfp, "Charlie", "Three")) != (const char *)0);
            ASSERT(strcmp(value, "333") == 0);
            assay_config_set(cfp, "Charlie", "Three", "CCC");
            ASSERT((value = assay_config_get(cfp, "Alfa", "One")) != (const char *)0);
            ASSERT(strcmp(value, "A") == 0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Two")) == (const char *)0);
            ASSERT((value = assay_config_get(cfp, "Alfa", "Three")) == (const char *)0);
...

    {
        ...
        {
            assay_config_set(cfp, "Alfa", "One", "1");
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Alfa"), "One"));
            assay_config_set(cfp, "Bravo", "One", "11");
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Bravo"), "One"));
            assay_config_set(cfp, "Bravo", "Two", "22");
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Bravo"), "Two"));
            assay_config_set(cfp, "Charlie", "One", "111");
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Charlie"), "One"));
            assay_config_set(cfp, "Charlie", "Two", "222");
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Charlie"), "Two"));
            assay_config_set(cfp, "Charlie", "Three", "333");
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Charlie"), "Three"));
        }
        ASSERT(assay_config_audit(cfp) == (void *)0);
        {
            assay_config_get(cfp, "Alfa", "One");
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Alfa"), "One"));
            assay_config_get(cfp, "Bravo", "One");
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Bravo"), "One"));
            assay_config_get(cfp, "Bravo", "Two");
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Bravo"), "Two"));
            assay_config_get(cfp, "Charlie", "One");
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Charlie"), "One"));
            assay_config_get(cfp, "Charlie", "Two");
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Charlie"), "Two"));
            assay_config_get(cfp, "Charlie", "Three");
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Charlie"), "Three"));
        }
        ASSERT(assay_config_audit(cfp) == (void *)0);
        {
            ASSERT(assay_config_cached(cfp) == assay_property_seek(assay_section_seek(cfp, "Charlie"), "Three"));
            assay_property_destroy(assay_property_seek(assay_section_seek(cfp, "Charlie"), "Three"));
            ASSERT(assay_property_seek(assay_section_seek(cfp, "Charlie"), "Three") == (assay_property_t *)0);
            ASSERT(assay_config_cached(cfp) == (assay_property_t *)0);
        }
        ASSERT(assay_config_audit(cfp) == (void *)0);
        assay_config_destroy(cfp);
