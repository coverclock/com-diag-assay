...
int main(void)
{
...

    {
        ...
        ASSERT(assay_section_name_get(scp) != SECTION);
        ASSERT(strcmp(assay_section_name_get(scp), SECTION) == 0);
        /**/
        ...
        ASSERT(assay_property_key_get(prp) != KEY);
        ASSERT(strcmp(assay_property_key_get(prp), KEY) == 0);
        /**/
        length = 0xa5a5a5a5;
