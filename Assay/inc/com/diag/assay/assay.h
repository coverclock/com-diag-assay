 ...
 * software tools.
 *
 * The scanner and parser code generated by Flex and Bison uses a lot of
 * static variables, as does Assay to communicate with it. Hence, loading
 * configuration files must be serialized. Once the file is loaded, however,
 * different configuration objects can be accessed in separate threads.
 *
 * REFERENCES
 *
